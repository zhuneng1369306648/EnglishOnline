...
<div class="col-md-2">
    <ul class="nav nav-pills nav-stacked" id="nav">
        ...
        <li><a href="controlSubject">题库管理<span class="glyphicon glyphicon-book pull-right"/></a></li>
        <li><a href="${ctx}/admin/teacherIndex">添加试题<span class="glyphicon glyphicon-book pull-right"/></a></li>
